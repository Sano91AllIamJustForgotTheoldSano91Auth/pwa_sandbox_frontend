        ...
        animations: [
          {
            elements: {
              eV7AHjSyn9J2: {
                transform: {
                  data: { s: { x: 9.786468, y: 9.217933 }, t: { x: -12, y: -11.625 } },
                  keys: {
                    o: [
                      {
                        t: 500,
                        v: { x: -97.86468, y: 1162.070698, type: 'corner' },
                        e: [0.42, 0, 0.58, 1],
                      },
                      { t: 3500, v: { x: 2069.694578, y: -95.636055, type: 'corner' } },
                      {
                        t: 6500,
                        v: { x: -97.86468, y: 1162.070698, type: 'corner' },
                        e: [0.42, 0, 0.58, 1],
              ...
              eV7AHjSyn9J6: {
                transform: {
                  data: {
                    r: -180,
                    s: { x: -0.060055, y: 0.051114 },
                    t: { x: -5128.30188, y: -5232.95465 },
                  },
                  keys: {
                    o: [
                      {
                        t: 1000,
                        v: { x: 2169.258927, y: 1295.787759, type: 'corner' },
                        e: [0.42, 0, 0.58, 1],
                      },
                      { t: 4000, v: { x: -249.029963, y: -215.787759, type: 'corner' } },
                      {
                        t: 7000,
                        v: { x: 2169.258927, y: 1295.787759, type: 'corner' },
                        e: [0.42, 0, 0.58, 1],
              ...
              eV7AHjSyn9J18: {
                transform: {
                  data: { s: { x: 0.478939, y: 0.391594 }, t: { x: -513.087204, y: -513.517288 } },
                  keys: {
                    o: [
                      {
                        t: 1500,
                        v: { x: -195.72936, y: 516.745021, type: 'corner' },
                        e: [0.42, 0, 0.58, 1],
                      },
                      { t: 4500, v: { x: 2115.78871, y: 507.824065, type: 'corner' } },
                      {
                        t: 7500,
                        v: { x: -195.72936, y: 516.745021, type: 'corner' },
                        e: [0.42, 0, 0.58, 1],
              ...
              eV7AHjSyn9J25: {
                transform: {
                  data: { t: { x: -259.149994, y: -259.149994 } },
                  keys: {
                    o: [
                      {
                        t: 0,
                        v: { x: 869.160237, y: -259.149994, type: 'corner' },
                        e: [0.42, 0, 0.58, 1],
                      },
                      { t: 3000, v: { x: 874.636207, y: 1366.164744, type: 'corner' } },
                      {
                        t: 6000,
                        v: { x: 869.160237, y: -259.149994, type: 'corner' },
                        e: [0.42, 0, 0.58, 1],
            ...
            s: '|',
          },
        ],
        options: 'MDGAxMDgyMjk3YTTdiNjg3OTdiYMjlJNDEyOTcYzNzY2ODZiMjKk4NA|',
      },
      '__SVGATOR_PLAYER__',
      window,
      document,
